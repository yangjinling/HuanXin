package com.hyphenate.easeui.chatrow;
...
public interface EaseCustomChatRowProvider {
     ...
     * @return
     */
    com.hyphenate.easeui.widget.chatrow.EaseChatRow getCustomChatRow(EMMessage message, int position, BaseAdapter adapter);
